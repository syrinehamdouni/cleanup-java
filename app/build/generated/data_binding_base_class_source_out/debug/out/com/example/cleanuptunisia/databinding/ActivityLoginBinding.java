...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull EditText email,
      @NonNull Button loginButton, @NonNull ConstraintLayout main, @NonNull EditText password,
      @NonNull Button signupButton, @NonNull TextView signupText) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, email, loginButton, main,
          password, signupButton, signupText);
    }
